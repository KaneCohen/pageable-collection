			...
			var View = Backbone.View.extend({
				...
				getPrevLink: function() {
					if (this.collection.hasPrevPage()) {
						return '<li class="page-next"><a href="'+this.collection.getPaginatorUrl(this.collection.state.currentPage - 1, true)+'" data-page="'+(this.collection.state.currentPage - 1)+'"><i class="icon iconSmallArrowLeft"></i></a></li>';
					}
					return '';
				},
				getNextLink: function() {
					if (this.collection.hasNextPage()) {
						return '<li class="page-next"><a href="'+this.collection.getPaginatorUrl(this.collection.state.currentPage + 1, true)+'" data-page="'+(this.collection.state.currentPage + 1)+'"><i class="icon iconSmallArrowRight"></i></a></li>';
					}
					return '';
				},
